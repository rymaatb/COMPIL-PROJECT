...
_lr_productions = [
  ...
  ('statement -> type declaration_list SEMICOLON','statement',3,'p_statement_declaration','pseudoMain.py',183),
  ('statement -> CONST type ID EQUALS expression SEMICOLON','statement',6,'p_statement_declaration','pseudoMain.py',184),
  ('declaration_list -> declaration','declaration_list',1,'p_declaration_list','pseudoMain.py',222),
  ('declaration_list -> declaration COMMA declaration_list','declaration_list',3,'p_declaration_list','pseudoMain.py',223),
  ('declaration -> ID','declaration',1,'p_declaration','pseudoMain.py',233),
  ('declaration -> ID EQUALS expression','declaration',3,'p_declaration','pseudoMain.py',234),
  ('statement -> ID EQUALS expression SEMICOLON','statement',4,'p_statement_assignment','pseudoMain.py',245),
  ('type -> INT_TYPE','type',1,'p_type','pseudoMain.py',254),
  ('type -> FLOAT_TYPE','type',1,'p_type','pseudoMain.py',255),
  ('type -> BOOL_TYPE','type',1,'p_type','pseudoMain.py',256),
  ('type -> CHAR_TYPE','type',1,'p_type','pseudoMain.py',257),
  ('factor -> INTEGER','factor',1,'p_factor_number','pseudoMain.py',261),
  ('factor -> FLOAT','factor',1,'p_factor_number','pseudoMain.py',262),
  ('factor -> CHAR','factor',1,'p_factor_number','pseudoMain.py',263),
  ('factor -> BOOL','factor',1,'p_factor_number','pseudoMain.py',264),
  ('factor -> MINUS factor','factor',2,'p_factor_number','pseudoMain.py',265),
  ('factor -> PLUS factor','factor',2,'p_factor_number','pseudoMain.py',266),
  ('factor -> LPAREN INTEGER RPAREN','factor',3,'p_factor_number','pseudoMain.py',267),
  ('factor -> LPAREN FLOAT RPAREN','factor',3,'p_factor_number','pseudoMain.py',268),
  ('factor -> LPAREN MINUS FLOAT RPAREN','factor',4,'p_factor_number','pseudoMain.py',269),
  ('statements -> statement','statements',1,'p_statements','pseudoMain.py',290),
  ('statements -> statement statements','statements',2,'p_statements','pseudoMain.py',291),
  ('statement -> simple_assignment','statement',1,'p_statement','pseudoMain.py',298),
  ('statement -> array_declarationTab','statement',1,'p_statement','pseudoMain.py',299),
  ('statement -> declaration_assignment','statement',1,'p_statement','pseudoMain.py',300),
  ('statement -> array_assignment','statement',1,'p_statement','pseudoMain.py',301),
  ('statement -> type declarationTab_listTab SEMICOLON','statement',3,'p_statement','pseudoMain.py',302),
  ('statement -> const_declarationTab','statement',1,'p_statement','pseudoMain.py',303),
  ('const_declarationTab -> CONST type ID EQUALS expressionTab SEMICOLON','const_declarationTab',6,'p_const_declarationTab','pseudoMain.py',307),
  ('array_declarationTab -> type ID LBRACKET INTEGER RBRACKET SEMICOLON','array_declarationTab',6,'p_array_declarationTab','pseudoMain.py',313),
  ('declarationTab_listTab -> declarationTab','declarationTab_listTab',1,'p_declarationTab_listTab','pseudoMain.py',326),
  ('declarationTab_listTab -> declarationTab COMMA declarationTab_listTab','declarationTab_listTab',3,'p_declarationTab_listTab','pseudoMain.py',327),
  ('declarationTab -> ID','declarationTab',1,'p_declarationTab','pseudoMain.py',334),
  ('declarationTab -> ID EQUALS expressionTab','declarationTab',3,'p_declarationTab','pseudoMain.py',335),
  ('declarationTab -> ID LBRACKET INTEGER RBRACKET','declarationTab',4,'p_declarationTab','pseudoMain.py',336),
  ('expressionTab -> ID','expressionTab',1,'p_expressionTab','pseudoMain.py',349),
  ('expressionTab -> FLOAT','expressionTab',1,'p_expressionTab','pseudoMain.py',350),
  ('expressionTab -> INTEGER','expressionTab',1,'p_expressionTab','pseudoMain.py',351),
  ('expressionTab -> CHAR','expressionTab',1,'p_expressionTab','pseudoMain.py',352),
  ('factor -> ID LBRACKET expression RBRACKET','factor',4,'p_array_access','pseudoMain.py',359),
  ('array_assignment -> ID LBRACKET expressionTab RBRACKET EQUALS expressionTab SEMICOLON','array_assignment',7,'p_array_assignment','pseudoMain.py',378),
  ('declaration_assignment -> type ID EQUALS expression SEMICOLON','declaration_assignment',5,'p_declaration_assignment','pseudoMain.py',405),
  ('simple_assignment -> ID EQUALS expression SEMICOLON','simple_assignment',4,'p_variable_assignment','pseudoMain.py',435),
  ('expression -> expression OR term','expression',3,'p_expression_el','pseudoMain.py',494),
  ('expression -> term','expression',1,'p_expression_el','pseudoMain.py',495),
  ('term -> term AND factor','term',3,'p_term_tl','pseudoMain.py',515),
  ('term -> factor','term',1,'p_term_tl','pseudoMain.py',516),
  ('factor -> ID','factor',1,'p_factor_fl','pseudoMain.py',532),
  ('factor -> TRUE','factor',1,'p_factor_fl','pseudoMain.py',533),
  ('factor -> FALSE','factor',1,'p_factor_fl','pseudoMain.py',534),
  ('factor -> NOT ID','factor',2,'p_factor_fl','pseudoMain.py',535),
  ('statement -> READ LPAREN ID RPAREN SEMICOLON','statement',5,'p_read_statement','pseudoMain.py',649),
  ('statement -> READ LPAREN ID LBRACKET INTEGER RBRACKET RPAREN SEMICOLON','statement',8,'p_read_statement','pseudoMain.py',650),
  ('statement -> WRITE LPAREN write_content RPAREN SEMICOLON','statement',5,'p_write_statement','pseudoMain.py',720),
  ('write_content -> write_item','write_content',1,'p_write_content_single','pseudoMain.py',725),
  ('write_content -> write_content COMMA write_item','write_content',3,'p_write_content_multiple','pseudoMain.py',729),
  ('write_item -> ID','write_item',1,'p_write_item','pseudoMain.py',733),
  ('write_item -> ID LBRACKET INTEGER RBRACKET','write_item',4,'p_write_item','pseudoMain.py',734),
  ('statement -> FOR LPAREN initialisation COLON step COLON BorneSup RPAREN block','statement',9,'p_statement_FORloop','pseudoMain.py',770),
  ('initialisation -> ID EQUALS INTEGER','initialisation',3,'p_initialisation','pseudoMain.py',776),
  ('step -> INTEGER','step',1,'p_step','pseudoMain.py',785),
  ('step -> ID','step',1,'p_step','pseudoMain.py',786),
  ('BorneSup -> ID','BorneSup',1,'p_BorneSup','pseudoMain.py',806),
  ('block -> LBRACE statements RBRACE','block',3,'p_block','pseudoMain.py',826),
]
