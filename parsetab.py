...
_lr_productions = [
  ...
  ('declaration -> ID','declaration',1,'p_declaration','parser.py',208),
  ('declaration -> ID EQUALS expression','declaration',3,'p_declaration','parser.py',209),
  ('statement -> ID EQUALS expression SEMICOLON','statement',4,'p_statement_assignment','parser.py',221),
  ('type -> INT_TYPE','type',1,'p_type','parser.py',242),
  ('type -> FLOAT_TYPE','type',1,'p_type','parser.py',243),
  ('type -> BOOL_TYPE','type',1,'p_type','parser.py',244),
  ('type -> CHAR_TYPE','type',1,'p_type','parser.py',245),
  ('factor -> INTEGER','factor',1,'p_factor_number','parser.py',249),
  ('factor -> FLOAT','factor',1,'p_factor_number','parser.py',250),
  ('factor -> CHAR','factor',1,'p_factor_number','parser.py',251),
  ('factor -> BOOL','factor',1,'p_factor_number','parser.py',252),
  ('factor -> MINUS factor','factor',2,'p_factor_number','parser.py',253),
  ('factor -> PLUS factor','factor',2,'p_factor_number','parser.py',254),
  ('factor -> LPAREN INTEGER RPAREN','factor',3,'p_factor_number','parser.py',255),
  ('factor -> LPAREN FLOAT RPAREN','factor',3,'p_factor_number','parser.py',256),
  ('factor -> LPAREN MINUS FLOAT RPAREN','factor',4,'p_factor_number','parser.py',257),
  ('statements -> statement','statements',1,'p_statements','parser.py',278),
  ('statements -> statement statements','statements',2,'p_statements','parser.py',279),
  ('statements -> empty','statements',1,'p_statements','parser.py',280),
  ('statement -> simple_assignment','statement',1,'p_statement','parser.py',287),
  ('statement -> array_assignment','statement',1,'p_statement','parser.py',288),
  ('declaration -> array_declarationTab','declaration',1,'p_declaration_t','parser.py',291),
  ('declaration -> type declarationTab_listTab SEMICOLON','declaration',3,'p_declaration_t','parser.py',292),
  ('declaration -> const_declarationTab','declaration',1,'p_declaration_t','parser.py',293),
  ('simple_assignment -> ID EQUALS expressionTab SEMICOLON','simple_assignment',4,'p_simple_assignment','parser.py',296),
  ('const_declarationTab -> CONST type ID EQUALS expressionTab SEMICOLON','const_declarationTab',6,'p_const_declarationTab','parser.py',313),
  ('array_declarationTab -> type ID LBRACKET INTEGER RBRACKET SEMICOLON','array_declarationTab',6,'p_array_declarationTab','parser.py',320),
  ('declarationTab_listTab -> declarationTab','declarationTab_listTab',1,'p_declarationTab_listTab','parser.py',334),
  ('declarationTab_listTab -> declarationTab COMMA declarationTab_listTab','declarationTab_listTab',3,'p_declarationTab_listTab','parser.py',335),
  ('declarationTab -> ID','declarationTab',1,'p_declarationTab','parser.py',342),
  ('declarationTab -> ID EQUALS expressionTab','declarationTab',3,'p_declarationTab','parser.py',343),
  ('declarationTab -> ID LBRACKET INTEGER RBRACKET','declarationTab',4,'p_declarationTab','parser.py',344),
  ('expressionTab -> ID','expressionTab',1,'p_expressionTab','parser.py',357),
  ('expressionTab -> FLOAT','expressionTab',1,'p_expressionTab','parser.py',358),
  ('expressionTab -> INTEGER','expressionTab',1,'p_expressionTab','parser.py',359),
  ('expressionTab -> CHAR','expressionTab',1,'p_expressionTab','parser.py',360),
  ('factor -> ID LBRACKET expressionTab RBRACKET','factor',4,'p_array_access','parser.py',365),
  ...
  ('statement -> ID EQUALS expression_arithmetique SEMICOLON','statement',4,'p_declarationArth','parser.py',640),
  ('expression_arithmetique -> expression_arithmetique PLUS term_arithmetique','expression_arithmetique',3,'p_expression_plus','parser.py',658),
  ('expression_arithmetique -> expression_arithmetique MINUS term_arithmetique','expression_arithmetique',3,'p_expression_minus','parser.py',663),
  ('expression_arithmetique -> term_arithmetique','expression_arithmetique',1,'p_expression_term','parser.py',667),
  ('term_arithmetique -> term_arithmetique MULTIPLY term_arithmetique','term_arithmetique',3,'p_term_multiply','parser.py',671),
  ('term_arithmetique -> term_arithmetique DIVIDE factor_arithmetique','term_arithmetique',3,'p_term_divide','parser.py',676),
  ('term_arithmetique -> factor_arithmetique','term_arithmetique',1,'p_term_factor','parser.py',680),
  ('factor_arithmetique -> ID','factor_arithmetique',1,'p_factor_id','parser.py',684),
  ('factor_arithmetique -> INTEGER','factor_arithmetique',1,'p_factor_id','parser.py',685),
  ('factor_arithmetique -> FLOAT','factor_arithmetique',1,'p_factor_id','parser.py',686),
  ('factor_arithmetique -> LPAREN expression_arithmetique RPAREN','factor_arithmetique',3,'p_factor_parens','parser.py',691),
  ('statement -> READ LPAREN ID RPAREN SEMICOLON','statement',5,'p_read_statement','parser.py',825),
  ('statement -> READ LPAREN ID LBRACKET INTEGER RBRACKET RPAREN SEMICOLON','statement',8,'p_read_statement','parser.py',826),
  ('statement -> WRITE LPAREN write_content RPAREN SEMICOLON','statement',5,'p_write_statement','parser.py',901),
  ('write_content -> write_item','write_content',1,'p_write_content_single','parser.py',906),
  ('write_content -> write_content COMMA write_item','write_content',3,'p_write_content_multiple','parser.py',910),
  ('write_item -> ID','write_item',1,'p_write_item','parser.py',916),
  ('write_item -> ID LBRACKET INTEGER RBRACKET','write_item',4,'p_write_item','parser.py',917),
  ('write_item -> STRING','write_item',1,'p_write_item','parser.py',918),
  ('statement -> FOR LPAREN initialisation COLON step COLON BorneSup RPAREN block','statement',9,'p_statement_FORloop','parser.py',949),
  ('initialisation -> ID EQUALS INTEGER','initialisation',3,'p_initialisation','parser.py',955),
  ('step -> INTEGER','step',1,'p_step','parser.py',964),
  ('step -> ID','step',1,'p_step','parser.py',965),
  ('BorneSup -> ID','BorneSup',1,'p_BorneSup','parser.py',973),
  ('block -> LBRACE statements RBRACE','block',3,'p_block','parser.py',978),
  ('statement -> IFTHEN','statement',1,'p_statementIf','parser.py',1074),
  ('statement -> IFTHENELSE','statement',1,'p_statementIf','parser.py',1075),
  ('IFTHENELSE -> IF LPAREN condition RPAREN block ELSE block','IFTHENELSE',7,'p_IFTHENELSE','parser.py',1082),
  ('IFTHEN -> IF LPAREN condition RPAREN block','IFTHEN',5,'p_IFTHEN','parser.py',1088),
  ('conditionIF -> IF LPAREN condition','conditionIF',3,'p_conditionIF','parser.py',1094),
  ('condition -> ID EQ factor','condition',3,'p_condition','parser.py',1100),
  ('condition -> ID NEQ factor','condition',3,'p_condition','parser.py',1101),
  ('condition -> ID LT factor','condition',3,'p_condition','parser.py',1102),
  ('condition -> ID LTE factor','condition',3,'p_condition','parser.py',1103),
  ('condition -> ID GT factor','condition',3,'p_condition','parser.py',1104),
  ('condition -> ID GTE factor','condition',3,'p_condition','parser.py',1105),
  ('condition -> factor EQ factor','condition',3,'p_condition','parser.py',1106),
  ('condition -> factor NEQ factor','condition',3,'p_condition','parser.py',1107),
  ('condition -> factor LT factor','condition',3,'p_condition','parser.py',1108),
  ('condition -> factor LTE factor','condition',3,'p_condition','parser.py',1109),
  ('condition -> factor GT factor','condition',3,'p_condition','parser.py',1110),
  ('condition -> factor GTE factor','condition',3,'p_condition','parser.py',1111),
]
